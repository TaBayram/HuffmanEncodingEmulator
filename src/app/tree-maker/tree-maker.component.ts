...
export class TreeMakerComponent implements OnInit {
  ...
  onSubmit() {
    ...
    let node0 = new p5Node(node2, 0, 0, 40, { r: 255, g: 200, b: 100, a: 255 }); node.leftNode = node0;
    let node01 = new p5Node(node3, 0, 0, 40, { r: 255, g: 200, b: 100, a: 255 }); node.rightNode = node01;
